...
def loadTFdataset(name, type, path='/content/drive/MyDrive/Shubhada/MultiModalClassifier/cats_and_dogs_filtered/', img_height=200, img_width=200, batch_size=32):
    global BATCH_SIZE
